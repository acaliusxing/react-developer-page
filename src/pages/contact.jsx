                    ...
                    <div className = "row">
                        ...
                        <div className = "col-sm-6 col-md-6">
                            <div className = "contact-form-body">
                                <form>
                                <div className = "row">
                                    <InputComponent key="input001" type="firstname" title="First Name" classtype="col-sm-6 col-md-6"  />
                                    <InputComponent key="input002" type="lastname" title="Last Name" classtype="col-sm-6 col-md-6"  />
                                </div>
        
                                <div className = "row">
                                    <InputComponent key="input003" type="email" title="Email" classtype="col-sm-12 col-md-12"  />
                                </div>
